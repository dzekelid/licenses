...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/licenses/master/_listings/microsoft-graph/apis.md
...
- name: Microsoft Graph API - Assign License
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/licenses/master/_listings/microsoft-graph/usersid--userprincipalnameassignlicense-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/licenses/master/_listings/microsoft-graph/usersid--userprincipalnameassignlicense-post-openapi.md
- name: Microsoft Graph API - Assign License
  x-api-slug: usersid--userprincipalnameassignlicense-post
  description: assignLicense Add or remove subscriptions for the user. You can also
    enable and disable specific plans associated with a subscription.
